...
extern struct List* list_create_head(struct Memory* memory, void* new_value);
extern struct List* list_create_empty(struct Memory* memory);
extern int list_is_empty(struct List* list);
extern void list_insert_tail(struct Memory* memory, struct List* list, void* new_value);
